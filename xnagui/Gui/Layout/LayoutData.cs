...
namespace Ruminate.GUI.Framework {
    ...
    public class LayoutData {
        ...
        /// <summary>
        /// The screen space the element occupies.
        /// </summary>
        public Rectangle RenderArea { get { return _renderArea; } }

        /// <summary>
        /// The area to the element where the children can receive input.
        /// </summary>        
        ...
        // #############################################################
        // Allows translation of child elements. For use by containers
        // that modify the location of their children.

        // The amount child elements should be offset from their 
